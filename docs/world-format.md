...
`player_inventory` is the authored new-game inventory. Save v2 replaces it with the saved inventory snapshot on load; reset returns to this authored value. It is content input, not a live runtime container.
